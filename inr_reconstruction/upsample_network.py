...
if __name__ == '__main__':
    ...
    ckpt_path = os.path.join(experiment_dir_agave, 'nbp_output', exp, 'models', '025000.tar')
    dev = 'cuda:0'
    num_layers = 4
    num_neurons = 128
    scene_voxels = None
    ...
    np.save(os.path.join(experiment_dir_agave, 'nbp_output',
    ...
    scipy.io.savemat(os.path.join(experiment_dir_agave, 'nbp_output',
